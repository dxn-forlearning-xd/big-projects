    ...
    <Box>
      ...
      >
        <Box
          ...
          alignItems="center"
        >
          <Header title="首页" subtitle="欢迎登录demo后台" />
        </Box>
        ...
        >
          <Box p="10px 30px">
            <Box
              ...
              alignItems="center"
            >
              <Typography variant="h6">低库存商品</Typography>
            ...
            {lowProduct && (
              ...
              >
                <Box>
                  ...
                  <Typography> 库存: {lowProduct.stock}</Typography>
                </Box>
                <Box
                  component="img"
                  src={lowProduct.img}
        ...
        >
          <Box p="10px 30px">
            <Box
              ...
              alignItems="center"
            >
              <Typography variant="h6">订单金额</Typography>
            </Box>
        ...
        >
          <Box p="10px 30px">
            <Box
              ...
              alignItems="center"
            >
              <Typography variant="h6">高销量商品</Typography>
              <SellOutlinedIcon />
            </Box>
            {topProduct && (
              <Box
        ...
        >
          <Box p="10px 30px">
            <Typography variant="h6">库存</Typography>
